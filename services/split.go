...
// CalculateSplit computes the 10% platform cut plus an estimated Stripe fee.
// HostPayout remains the legacy net-after-estimated-fee value.
...
// HostShare is the advertised cross-provider split: the host receives 90% of
// ticket revenue and the platform retains 10% before provider fees.
func (s SplitPayout) HostShare() float64 {
